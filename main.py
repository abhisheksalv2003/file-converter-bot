...
# env
bot_token = os.environ.get("TOKEN", "5756163314:AAEQkNWhtIc6crUynl7AaxfK05B_rP_Vo1M") 
api_hash = os.environ.get("HASH", "0806bbd55b80b2af490d590aa8b9cb08") 
api_id = os.environ.get("ID", "18134181")
